    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: "카드 모양과 담는 정보가 다릅니다. 18홀은 좌우로 긴 스트립이라 가로 영상 아래쪽에 깔기 좋고, 9홀은 더 짧고 두꺼운 판, 3홀은 세 홀만 담은 작은 띠, 1홀은 현재 홀 상태만 보여주는 방송 스타일 오버레이입니다. 모두 투명 배경 오버레이라 영상 화면 비율과는 무관하니, 화면에서 올릴 자리를 기준으로 고르세요.",
          },
          {
            q: "홀별 N장 저장은 뭔가요?",
          ...
          {
            q: "선수 이름·골프장·날짜는 어디서 넣나요?",
            a: "18홀·9홀·3홀은 '기본 정보'에서 이름(최대 7자), 골프장, 날짜를 넣습니다. 골프장은 전국 골프장 541곳 목록에서 자동완성되고, 목록에 없으면 직접 입력해도 됩니다. 1홀 카드는 카드 스타일 버튼 옆의 이름 입력란에서 따로 지정합니다.",
          },
          {
            q: "앱처럼 설치할 수 있나요?",
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: "The shape and the amount of information differ. 18-hole is a wide strip that sits well along the bottom of a landscape video, 9-hole is a shorter and taller panel, 3-hole is a small band for three holes, and 1-hole is a broadcast-style overlay showing only the current hole. All are transparent overlays, independent of your video's aspect ratio — choose by where you want it on screen.",
          },
          {
          ...
          {
            q: "Where do I enter player name, course and date?",
            a: "For 18/9/3 holes, use 'Basic Info' to enter the name (up to 7 characters), course and date. The course field autocompletes from a directory of 541 Korean golf courses, and you can type a name that is not on the list. The 1-hole card has its own name field next to the card style buttons.",
          },
          {
