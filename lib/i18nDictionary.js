...
export const dictionary = {
  ko: {
    ...
    // h1 문구다. 검색엔진이 읽는 제목이라 "이미지"처럼 두루뭉술한 말 대신
    // 실제로 검색되는 말("스코어카드", "투명 배경 PNG")을 쓴다.
    "home.subtitle": "골프 스코어카드를 투명 배경 PNG로 만들어 영상에 올리세요",
    "home.roundTitle": "내 라운드 기록",
    "home.start": "시작하기",
    // 홈 카드 숫자 옆 단위. 탭 라벨(tab.hole18)과 같은 표기를 쓴다.
    "home.holesUnit": "홀",
    "home.preparing": "준비 중",
    ...
    // 첫 화면 아래 안내 본문. 홈에서 크롤러가 읽을 유일한 설명이므로
    // 무엇을 만드는 도구인지 문장으로 적는다.
    "home.aboutTitle": "골프 스코어카드 오버레이 만들기",
    "home.aboutBody":
      "스코어를 입력하면 영상 위에 그대로 올릴 수 있는 골프 스코어카드를 만들어 줍니다. 배경이 투명한 PNG로 저장되니 편집 프로그램에서 배경을 지울 필요 없이 얹기만 하면 됩니다. 회원가입이나 설치 없이 브라우저에서 바로 쓰고, 입력한 내용은 이 기기에만 남습니다.",
    // 아래 카드 4종의 이름. 화면에는 숫자+단위만 보이고 이 이름은 aria-label로 쓰인다.
    // 사전 키는 경로 끝(Hole18…)에서 파생된다.
    "home.typeHole18": "18홀 스코어카드",
    "home.typeHole9": "9홀 스코어카드",
    "home.typeHole3": "3홀 스코어카드",
    "home.typeHole1": "1홀 카드",
    ...
    "source.linked18": "18홀 입력값 연동",
    "source.noData": "18홀 데이터 없음",
    "source.noScores": "18홀 스코어 없음",
    ...
    "records.enter18": "18홀 입력",
    "records.load": "기록 불러오기",
    ...
    // 현재 화면 언어로 읽히므로 "전환할 대상"을 그 언어로 적는다.
    "a11y.langToggle": "영어로 전환",

    // 로그인 (myRound 플래그가 꺼져 있어 비활성 안내만 노출)
    "login.disabledDetail": "사용자 인증과 라운딩 기록 저장 기능은 정식 인증 구조를 붙이기 전까지 닫아두었습니다.",
  ...
  en: {
    // HomeHub
    "home.title": "Golf Studio",
    "home.subtitle": "Turn golf scores into transparent PNG overlays for your videos",
    "home.roundTitle": "My Round",
    "home.start": "Start",
    // Unit shown next to the big number on home cards. Matches the tab labels (tab.hole18).
    "home.holesUnit": "H",
    ...
    "home.aboutTitle": "Golf Scorecard Overlay Maker",
    "home.aboutBody":
      "Enter your scores and get a golf scorecard you can drop straight onto video. It saves as a PNG with a transparent background, so there is no background to cut out in your editor. No sign-up and no install — it runs in the browser and what you type stays on this device.",
    "home.typeHole18": "18-hole scorecard",
    "home.typeHole9": "9-hole scorecard",
    "home.typeHole3": "3-hole scorecard",
    "home.typeHole1": "Single-hole card",
    ...
    "source.linked18": "Linked to 18-hole entry",
    "source.noData": "No 18-hole data",
    "source.noScores": "No 18-hole scores",
    ...
    "records.enter18": "Enter 18 Holes",
    "records.load": "Load Records",
    ...
    "a11y.langToggle": "Switch to Korean",

    // Login (only the disabled notice shows while the myRound flag is off)
    "login.disabledDetail": "Authentication and round history save are closed until proper auth is integrated.",
