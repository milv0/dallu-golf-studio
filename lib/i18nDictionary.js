...
export const dictionary = {
  ko: {
    ...
    "home.createTitle": "골프 스코어카드 만들기",
    "home.createHint": "원하는 카드 형식을 선택하세요",
    ...
    "hole.currentScore": "현재 스코어",
    "hole.classicDetails": "Classic 상세 정보",
    "hole.labelHole": "홀",
    "hole.par": "PAR",
    "hole.none": "없음",
    "hole.distance": "거리",
    ...
    "a11y.scoreMode": "스코어 입력 방식",
    "a11y.distanceUnit": "거리 단위",
    "a11y.holeCardStyle": "1홀 카드 스타일",
    "a11y.cardFormatNav": "카드 형식 선택",
  ...
  en: {
    // HomeHub
    "home.title": "Golf Studio",
    "home.createTitle": "Create a Golf Scorecard",
    "home.createHint": "Choose a card format to get started",
    ...
    "hole.currentScore": "Current Score",
    "hole.classicDetails": "Classic Details",
    "hole.labelHole": "Hole",
    "hole.par": "PAR",
    "hole.none": "None",
    ...
    "a11y.scoreMode": "Score input mode",
    "a11y.distanceUnit": "Distance unit",
    "a11y.holeCardStyle": "Single-hole card style",
    "a11y.cardFormatNav": "Card format selection",
    ...
    // Capacitor app-only hamburger menu
    "a11y.appMenu": "Menu",
