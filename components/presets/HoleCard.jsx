...
export default function HoleCard({ data, theme = "dark" }) {
  ...
  return (
    <svg viewBox={`0 0 ${w} ${size.h}`} width={w} height={size.h}
      ...
      <text x={segW / 2} y="146" textAnchor="middle" fill={c.accent} fontFamily={HEAD}
            fontSize="29" fontWeight="700" letterSpacing="1" className="score-meta-lock">PAR {data.par || "–"}</text>
